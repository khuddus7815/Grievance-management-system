...
?>
				...
				<ul class="nav pcoded-inner-navbar ">
					...
					<li class="nav-item">
					    <a href="register-grievance.php" class="nav-link "><span class="pcoded-micon"><i class="feather icon-file-text"></i></span><span class="pcoded-mtext">Register Grievance</span></a>
					</li>
					<li class="nav-item">
					    <a href="grievance-history.php" class="nav-link "><span class="pcoded-micon"><i class="feather icon-align-justify"></i></span><span class="pcoded-mtext">Grievances History</span></a>
					</li>
				</ul>
			</div>
		</div>
