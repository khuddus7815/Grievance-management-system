...
?>
											<div class="media">
												...
												<div class="media-body">
													...
													<p>Grievance No.<a href="complaint-details.php?cid=<?php echo htmlentities($row['complaintNumber']);?>"><?php echo htmlentities($row['complaintNumber']);?> at <small><?php echo htmlentities($row['regDate']);?></small> </a></p>
												</div>
											</div>
											<br><?php $cnt=$cnt+1; } ?>
										</li>
